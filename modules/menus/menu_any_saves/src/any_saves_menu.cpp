...
KEEP_FUNC AnySavesMenu::AnySavesMenu(Cursor& cursor)
    : Menu(cursor),
      lines{{"ordon gate clip", ORDON_GATE_CLIP_INDEX, "Gate Clip outside Ordon Spring"},
            {"back in time", BACK_IN_TIME_INDEX, "Back In Time off the Ordon Spring bridge"},
            {"faron gate clip 1", FARON_GATE_CLIP_1_INDEX, "Epona Gate Clip from Faron to Hyrule Field South"},
            {"seam clip", SEAM_CLIP_INDEX, "Epona Seam Clip in Hyrule Field South"},
            {"epona oob to gorge", OOB_TO_GORGE_INDEX, "The out of bounds movement after Epona Seam Clip"},
            {"faron gate clip 2", FARON_GATE_CLIP_2_INDEX, "Epona Gate Clip from Hyrule Field South to Faron"},
            {"goats", GOATS_INDEX, "Goat herding 2"},
            ...
            {"epona oob to lanayru", EPONA_OOB_INDEX, "Epona out of bounds from Kakariko to Flight by Fowl"},
            {"quaforce clip", QUAFORCE_CLIP_INDEX, "Clip through the edge of the wall in Flight by Fowl's house"},
            ...
            {"pot push 2", POT_PUSH_2_INDEX, "Pot push with the pots already placed"},
...
void AnySavesMenu::draw() {
    ...
    if (GZ_getButtonTrig(SELECTION_BUTTON)) {
        ...
        special AnySpecials[] = {
            ...
            special(ARG_CS_SKIP_INDEX, nullptr, SaveMngSpecial_Sword),
            special(OOB_TO_GORGE_INDEX, SaveMngSpecial_HorseSpawn, SaveMngSpecial_OobToGorge),
            special(FARON_GATE_CLIP_1_INDEX, SaveMngSpecial_HorseSpawn, SaveMngSpecial_FaronGate1),
            special(FARON_GATE_CLIP_2_INDEX, SaveMngSpecial_HorseSpawnRunning, SaveMngSpecial_FaronGate2),
            special(REBITE_INDEX, SaveMngSpecial_reBiTE, nullptr),
            special(FOREST_TEMPLE_INDEX, SaveMngSpecial_BossFlags, nullptr),
            special(POT_PUSH_INDEX, SaveMngSpecial_BossFlags, nullptr),
            special(POT_PUSH_2_INDEX, SaveMngSpecial_BossFlags, SaveMngSpecial_PotPush2),
