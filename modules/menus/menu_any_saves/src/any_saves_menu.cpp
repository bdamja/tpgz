...
KEEP_FUNC AnySavesMenu::AnySavesMenu(Cursor& cursor)
    : Menu(cursor),
      lines{
          ...
          {"poe gate skip", PGS_INDEX, "Bouncin' with Boney"},
          {"pgs ebmb", EBMB_INDEX, "Ending Blow Moon Boots during poe gate skip"},
...
void AnySavesMenu::draw() {
    ...
    if (GZ_getButtonTrig(SELECTION_BUTTON)) {
        special AnySpecials[] = {
            ...
            special(EBMB_INDEX, nullptr, SaveMngSpecial_SpawnPGS),
